...
#define SET_USI_TO_SEND_ACK()                                                                                                                     \
    {                                                                                                                                             \
        ...
        USISR = (0 << USI_START_COND_INT) | (1 << USIOIF) | (1 << USIPF) | (1 << USIDC) | (0x0E << USICNT0); /* set USI counter to shift 1 bit */ \
    }
...
#define SET_USI_TO_READ_ACK()                                                                                                  \
    {                                                                                                                          \
        ...
        USIDR = 0;                                                                                                             \
        /* clear all interrupt flags, except Start Cond */                                                                     \
        USISR = (0 << USI_START_COND_INT) | (1 << USIOIF) | (1 << USIPF) | (1 << USIDC) | /* set USI counter to shift 1 bit */ \
            (0x0E << USICNT0);                                                                                                 \
    }
...
#define SET_USI_TO_TWI_START_CONDITION_MODE()                                                                                                             \
    {                                                                                                                                                     \
        ...
        USISR = /* clear all interrupt flags, except Start Cond */                                                                                        \
            (0 << USI_START_COND_INT) | (1 << USIOIF) | (1 << USIPF) | (1 << USIDC) | (0x0 << USICNT0);                                                   \
    }
...
#define SET_USI_TO_SEND_DATA()                                                                                              \
    {                                                                                                                       \
        ...
        DDR_USI |= (1 << PORT_USI_SDA);                                                                                     \
        /* clear all interrupt flags, except Start Cond */                                                                  \
        USISR = (0 << USI_START_COND_INT) | (1 << USIOIF) | (1 << USIPF) | (1 << USIDC) | /* set USI to shift out 8 bits */ \
            (0x0 << USICNT0);                                                                                               \
    }
